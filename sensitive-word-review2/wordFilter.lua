...
function findSensitiveWords(conf,str)
    ...
    print_r({"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"})
    print_r({ACTrie})
    print_r({"ssssssssssssssssssssssssssssssssssssssssssssssss"})
    ...
    if ACTrie == nil or conf.addSensitiveWords ~= addSensitiveWords then
        print_r({"uuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu76543"})
        ngx.shared.addSensitiveWords = conf.addSensitiveWords
